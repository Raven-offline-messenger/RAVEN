...
class _PostComposerSheetState extends State<PostComposerSheet> 
  ...
  PostVisibility _selectedVisibility = PostVisibility.local; // Default to local
  ...
  Future<void> _post() async {
    ...
    try {
      ...
      final post = Post(
        ...
        isLocal: _selectedVisibility == PostVisibility.local,
  ...
  Widget _buildVisibilitySelector() {
    ...
    return GestureDetector(
      onTap: () {
        HapticFeedback.selectionClick();
        setState(() {
          // Cycle through: local -> friends -> public -> local
          switch (_selectedVisibility) {
            case PostVisibility.local:
              _selectedVisibility = PostVisibility.friendsOnly;
              break;
            case PostVisibility.friendsOnly:
              _selectedVisibility = PostVisibility.public;
              break;
            case PostVisibility.public:
              _selectedVisibility = PostVisibility.local;
              break;
          }
        });
      },
