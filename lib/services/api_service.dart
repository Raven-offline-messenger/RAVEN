...
class ApiService {
  ...
  static Future<bool> createPost(
    ...
    try {
      ...
      // Convert visibility enum to server format
      ...
      // Add location for local posts
      if (latitude != null && longitude != null) {
        body['latitude'] = latitude;
        body['longitude'] = longitude;
      }
      
      print('📤 [createPost] visibility=$visibilityStr, lat=$latitude, lng=$longitude');
